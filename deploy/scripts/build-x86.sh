...
OUTPUT_DIR="$ROOT_DIR/deploy/bin/x86"

echo "=============================================================================="
echo "  OpenWiki x86_64 发布包构建"
echo "  项目目录: $ROOT_DIR"
echo "=============================================================================="
...
echo ""
echo "=============================================================================="
echo "🎉 x86_64 发布包组装完成 (已清除旧产物与 openwiki 编译目录)！"
